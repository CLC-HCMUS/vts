...
def compute_cost_and_grad(theta, instances, total_internal_node_num,
  ...
  if rank == 0:
    ...
    print >> stderr, 'reconstruct error: ' + str(total_cost)
...
if __name__ == '__main__':
  ...
  instances_file = 'vtb_corpus_lower.txt'
    #options.instances
  ...
  instances_file_have_embedding = 'mini_corpus_have_embedding2.npy'
  ...
  if rank == 0:
    ...
    send_terminate_signal()
    opt_time = timer.toc()
    print >> stderr, 'saving parameters to hynguyen_theta_opt'
